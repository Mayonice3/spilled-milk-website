        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="animate-fade-in text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6 sm:mb-8 justify-center lg:justify-start">
              ...
              <Button variant="outline" size="lg" className="border-2 border-purple-500 text-purple-400 hover:bg-purple-900/50 px-6 sm:px-8 py-3 text-base sm:text-lg">
                View Our Work
              </Button>
            </div>
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 text-gray-400 text-sm sm:text-base justify-center lg:justify-start">
          ...
          <div className="relative animate-scale-in mt-8 lg:mt-0">
            <div className="bg-gray-800/90 backdrop-blur-sm p-4 sm:p-6 lg:p-8 rounded-2xl shadow-2xl border border-pink-500/30">
              <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
                <div className="text-center p-3 sm:p-4 bg-gradient-to-br from-gray-700 to-gray-600 rounded-xl border border-pink-500/20">
                  ...
                  <div className="text-xs sm:text-sm text-gray-300">Profile Views/Month</div>
                </div>
                <div className="text-center p-3 sm:p-4 bg-gradient-to-br from-gray-700 to-gray-600 rounded-xl border border-purple-500/20">
                ...
                <div className="text-center p-3 sm:p-4 bg-gradient-to-br from-gray-700 to-gray-600 rounded-xl border border-rose-500/20">
                ...
                <div className="text-center p-3 sm:p-4 bg-gradient-to-br from-gray-700 to-gray-600 rounded-xl border border-pink-500/20">
                  ...
                  <div className="text-xs sm:text-sm text-gray-300">Avg. Growth</div>
                </div>
              </div>
            </div>
          </div>
