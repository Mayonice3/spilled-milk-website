      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-4 gap-6 mb-12">
          <Card className="bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200 hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-stone-800">+2.4M</div>
          ...
          <Card className="bg-gradient-to-br from-stone-50 to-stone-100 border-stone-200 hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-stone-800">8.2%</div>
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200 hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-stone-800">1.8M</div>
          ...
          <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200 hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-stone-800">45.2K</div>
              <p className="text-xs text-green-600 flex items-center mt-1">
                <TrendingUp className="h-3 w-3 mr-1" />
                +31% from last month
              </p>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          <Card className="p-6 hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="text-xl text-stone-800">Follower Growth Over Time</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card className="p-6 hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="text-xl text-stone-800">Content Performance</CardTitle>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
        ...
        <Card className="p-6 hover:shadow-lg transition-shadow">
          <CardHeader>
            <CardTitle className="text-xl text-stone-800 text-center">Platform Engagement Rates</CardTitle>
          </CardHeader>
          <CardContent>
                ...
                {engagementData.map((item, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-stone-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      ></div>
                      <span className="font-medium text-stone-700">{item.platform}</span>
                    </div>
                    <span className="text-stone-600 font-semibold">{item.value}%</span>
                  </div>
                ))}
              </div>
            </div>
